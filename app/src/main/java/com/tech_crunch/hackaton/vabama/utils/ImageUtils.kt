package com.tech_crunch.hackaton.vabama.utils
...
object ImageUtils {
    ...
    fun displayRoundedPicture(context: Context, bitmap: Bitmap, into: ImageView) {
        val roundedBitmapDrawable = RoundedBitmapDrawableFactory.create(context.resources, scaleAndCropBitmap(bitmap))
    ...
    fun displayRoundedPicture(context: Context, from: String, into: ImageView, errorRes: Int): Target {
